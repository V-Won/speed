			...
			$radioCheckbox.find('input[type="checkbox"], input[type="radio"]').on({
                'change': function () {
                    var $this = $(this),
                          ...
                          $closest = $this.closest('[data-skin]').attr('data-skin', 'accept').removeClass('check');		//@160902
					...
					if(isDisabled == true && isChecked == true) $closest.addClass('check');								//@160902
...
(function ($, core, undefined) {
    ...
    var Modal = ui('Modal', /** @lends cjone.ui.Modal */ {
        ...
        layout: function() {
            ...
            width = Math.max(me.$el.outerWidth(), $layerPop.children().outerWidth(true));                  //@160119
            height = Math.max(me.$el.outerHeight(), $layerPop.children().outerHeight(true));               //@160119
            ...
            me.$el.width(width).height(height);                                                                     //@160119
        },
...
(function ($, core) {
    ...
    var BaseTab = core.ui.View.extend({
        ...
        defaults: {
            ...
            haze: true,
            isPreventDefault: true		//@160224-1
        },
        initialize: function (el, options) {
            var me = this, index;
            if (me.supr(el, options) === false) { return; }
